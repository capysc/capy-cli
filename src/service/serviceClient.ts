...
export class ServiceClient {
  ...
  // --- v3 invite blob + pickup (CAP-529, docs/invite-pickup-flow.md §4, §6c, §7) ---
  //
...
/**
 * A caller's own pending pickup row (CAP-529 §7.2), as returned by
 * `GET /invites/pending`. `organization_id` is not a column on
