...
export async function runWithFlowInteraction(operation: () => Promise<void>, devMode: boolean, descriptor: Readonly<{ command: 'capy' | 'rotate'; continuationTool: 'capy_onboard_continue' | 'capy_rotate_continue'; expectedUserId?: string; organizationId?: string; localHandoff?: boolean }> = { command: 'capy', continuationTool: 'capy_onboard_continue' }): Promise<void> {
